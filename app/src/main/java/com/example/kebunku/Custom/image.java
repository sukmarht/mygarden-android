package com.example.kebunku.Custom;
...
public class image extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public image(Context context, AttributeSet attributeSet, int defStyle){
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(posActX, posActY,Math.min(rowHeight,columnWidth)/2-32,mCircle);
    }
}
