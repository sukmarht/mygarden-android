...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ccbRemember = findViewById(R.id.Remember);
        ...
        btnConnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(edtId.getText().toString().trim().isEmpty()){
                    edtId.findFocus();
                    Toast.makeText(login.this, "Id Must Be Filled", Toast.LENGTH_LONG).show();
                    return;
                }
                if(edtKey.getText().toString().trim().isEmpty()){
                    edtKey.findFocus();
                    Toast.makeText(login.this, "Key Myst Be Filled", Toast.LENGTH_LONG).show();
                    return;
                }
            ...
            while(true){
                ...
                try {
                    if(input.ready()) {
                        ...
                        if (message != null) {
                            Log.d("DEBUGSUKMA", "Got message: " + message);
                            final JSONObject jsonObject = new JSONObject(message);

                            if (jsonObject.has("X_POSITION_CM")) {
                                if (fitur.isActive) {
                                    fitur.updateInfo(jsonObject);
                                }
                                ...
                                if (!fitur.isActive) {
                                    ...
                                    Intent intent = new Intent(login.this, fitur.class);
